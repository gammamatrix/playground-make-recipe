...
use Playground\Make\Recipe\Http\Requests\Date\FormDateRequest;
use Playground\Make\Recipe\Http\Requests\Date\SaveDateRequest;
...
class DateController extends Controller
{
     ...
     * Delete a recipe
     */
    public function delete(Manager $manager, string $recipe_slug, string $column): RedirectResponse
    {
     ...
     * Show the index.
     */
    public function index(string $recipe_slug, Manager $manager): View|RedirectResponse
    {
        $recipe = $manager->get($recipe_slug);
        // dd([
        //    '__METHOD__' => __METHOD__,
